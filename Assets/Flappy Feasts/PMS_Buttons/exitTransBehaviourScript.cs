...
public class exitTransBehaviourScript : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler, IPointerClickHandler
{
    public Image button;
    public Sprite originalSprite;
    public Sprite emptySprite;

    private exitButtonBehaviourScript script;

    // Start is called before the first frame update
    void Start()
    {
        script = GameObject.FindGameObjectWithTag("ExitButton").GetComponent<exitButtonBehaviourScript>();
    }
